...
// ===== Private Variables =====
static float accel_x_offset = 327.69;
static float accel_y_offset = 15.69;
static float accel_z_offset = -241.70;
static float gyro_x_offset =  -120.89;
static float gyro_y_offset = 39.49;
static float gyro_z_offset = -14.87;
